...
abstract: |
   The study examines the use of present-day geospatial data and advanced computational techniques to study maritime human movement during the early Holocene in the Eastern Mediterranean. As we examine a prehistoric time for which there are no available data, apart from few documented assumptions which can be found nowadays regarding vessel travel details (duration, path, etc.), this topic is considered challenging for both geoscientists and archaeologists.
output:
